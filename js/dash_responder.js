...
function generateStats(idA,idB,data){
    ...
    */
    ...
    $("#responder").append("<h4>People Cared For: " + pplCaredForR + "</h4>" + "<p style='text-align:center'>Last Updated: " + data[0].date + "</p>" +
    ...
    $("#phoenix").append("<h4>People Cared For: " + pplCaredForP + "</h4>" + "<p style='text-align:center'>Last Updated: " + data[0].date + "</p>" +
    ...
    $("#both").append("<h4>People Cared For: " + pplCaredFor + "</h4>" + "<p style='text-align:center'>Last Updated: " + data[0].date + "</p>" +
